...
export function detectPackageManagers(files) {
...
export function detectCommands(input) {
...
function addIf(values, value, condition) {
    if (condition)
        values.push(value);
}
...
function hasTests(files, commands) {
    return (commands.some((command) => command.name === "test") ||
